...
#region Custom Constructor
 ...
 public async ValueTask<MyAppResponse<Guid>> Handle(CreateCategoryCommand request, CancellationToken cancellationToken){
                                    ...
                                    //var dtoValidator = new CreateCategoryCommandValidator();

                                    //var validationResult = dtoValidator.Validate(request);

                                    //if (validationResult != null && validationResult.IsValid == false)
                                    //{
                                    //    return new MyAppResponse<Guid>(validationResult.Errors.Select(modelError => modelError.ErrorMessage).ToList());
                                    //}
